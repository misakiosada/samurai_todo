<template>
    ...
    <i class="fa fa-plus pl-3" data-toggle="modal" data-target="#reviewModal"></i><span class="align-middle"> New Review</span>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal" v-on:click="addNewReview;addNewState;addNewPlace;addNewCategory">Post</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card-group h-100">
            <div v-for="name in review.places">
...
export default {
    ...
    methods: {
        ...
        addNewPlace: function () {
            axios.defaults.headers['X-CSRF-TOKEN'] = $('meta[name=csrf-token]').attr('content');
            axios.defaults.headers['content-type'] = 'application/json';
            axios.post(`/reviews/${this.id}/place`, {
                name: this.placeName,
        ...
        getAllPlaces: function () {
            axios.get(`/reviews/places`).then((response) => {
